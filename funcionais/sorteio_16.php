...
for($contador3 = 0; $contador3 < 2; $contador3++){
...
for($contador4 = 0; $contador4 < 1; $contador4++){

  $comandoSql4="INSERT INTO tb_jogos (cod_torneio, fase) VALUES ($idTor4, 4)";

  $resultado=$pdo->query($comandoSql4);
}

for($contador5 = 0; $contador5 < 1; $contador5++){

  $comandoSql5="INSERT INTO tb_jogos (cod_torneio, fase) VALUES ($idTor4, 5)";

  $resultado=$pdo->query($comandoSql5);
}
?>
